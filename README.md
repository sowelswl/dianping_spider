...
感谢[IPWO](https://www.ipwo.net/?ref=githubSniper970119)对本repo的赞助。

本项目已完成对IPWO的适配，IPWO对大规模数据采集、价格监控或市场调研时，稳定的代理资源能够有效提升采集成功率(**免费试用**，流量不过期，爬虫使用保护账号不封号)。

同时，IPWO 提供全球 195+ 国家和地区的 9000 万+住宅 IP，帮助开发者更高效地获取所需数据，轻松绕过地域和频率限制。
...
**由于大众点评反爬非常非常非常非常非常严格，因此使用了cookie池、ip代理等诸多防ban手段【推荐使用[ip代理](https://www.ipwo.net/?ref=githubSniper970119)】，同时框架赋予了使用者很高的操作自由度，**
